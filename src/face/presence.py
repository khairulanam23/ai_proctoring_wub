...
class FacePresenceResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "timestamp_sec": round(self.timestamp_sec, 3) if self.timestamp_sec is not None else None,
            "faces": [
                {
                    "bbox": list(face.bbox),
...
class FacePresenceAnalyzer:
    ...
    def __init__(
        ...
        model_path: Union[str, Path] = "models/face_detection_yunet_2023mar.onnx",
