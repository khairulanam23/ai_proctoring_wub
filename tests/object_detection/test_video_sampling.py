...
from src.object_detection.relevance import ObjectRelevanceFilter
...
def test_frame_sample_and_metadata_serialization() -> None:
    ...
    meta = VideoMetadata(width=480, height=360, source_fps=30.0, total_frames=120, duration_seconds=4.0)
...
def test_video_frame_sampler_synthetic_video() -> None:
    ...
    for idx, (s, expected_idx) in enumerate(zip(samples, expected_indices)):
