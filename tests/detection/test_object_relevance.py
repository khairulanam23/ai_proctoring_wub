...
def test_relevance_filtering_classes(relevance_filter: ObjectRelevanceFilter) -> None:
    ...
    raw = make_raw_result(
        [
            DetectedObject(
                class_id=0, class_name="person", confidence=0.92, bbox=(10, 10, 100, 200)
            ),
            DetectedObject(
                class_id=67, class_name="cell phone", confidence=0.85, bbox=(20, 20, 50, 80)
            ),
            DetectedObject(class_id=32, class_name="tie", confidence=0.91, bbox=(40, 60, 55, 120)),
            DetectedObject(
                class_id=56, class_name="chair", confidence=0.74, bbox=(100, 100, 300, 400)
            ),
        ]
    )
...
def test_class_specific_confidence_threshold_override() -> None:
    ...
    raw = make_raw_result(
        [
            ...
            DetectedObject(
                class_id=67, class_name="cell phone", confidence=0.45, bbox=(10, 10, 50, 50)
            ),
            # laptop at 0.35: above class threshold (0.30) -> retained
            DetectedObject(
                class_id=63, class_name="laptop", confidence=0.35, bbox=(60, 60, 150, 150)
            ),
        ]
    )
...
def test_person_counting(relevance_filter: ObjectRelevanceFilter) -> None:
    ...
    # 0 persons
    report0 = relevance_filter.filter(
        make_raw_result(
            [
                DetectedObject(
                    class_id=67, class_name="cell phone", confidence=0.88, bbox=(10, 10, 50, 50)
                ),
            ]
        )
    )
    ...
    # 1 person
    report1 = relevance_filter.filter(
        make_raw_result(
            [
                DetectedObject(
                    class_id=0, class_name="person", confidence=0.91, bbox=(10, 10, 100, 200)
                ),
            ]
        )
    )
    ...
    # 2 persons
    report2 = relevance_filter.filter(
        make_raw_result(
            [
                DetectedObject(
                    class_id=0, class_name="person", confidence=0.91, bbox=(10, 10, 100, 200)
                ...
                DetectedObject(
                    class_id=0, class_name="person", confidence=0.86, bbox=(200, 10, 300, 200)
                ),
            ]
        )
    )
...
def test_multiple_simultaneous_relevant_objects(relevance_filter: ObjectRelevanceFilter) -> None:
    ...
    raw = make_raw_result(
        [
            DetectedObject(
                class_id=0, class_name="person", confidence=0.95, bbox=(10, 10, 100, 200)
            ),
            DetectedObject(
                class_id=67, class_name="cell phone", confidence=0.88, bbox=(30, 40, 60, 90)
            ),
            DetectedObject(
                class_id=63, class_name="laptop", confidence=0.82, bbox=(120, 150, 300, 280)
            ),
            DetectedObject(
                class_id=73, class_name="book", confidence=0.75, bbox=(320, 150, 400, 220)
            ),
        ]
    )
...
def test_proctoring_report_serialization(relevance_filter: ObjectRelevanceFilter) -> None:
    ...
    raw = make_raw_result(
        [
            DetectedObject(
                class_id=0, class_name="person", confidence=0.93, bbox=(10, 10, 100, 200)
            ),
